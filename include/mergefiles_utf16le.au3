...
MsgBox (0, "Mergefiles v0.1", "Merges files of a certain file type.  Put the script in the same folder as the files to be merged.  The script merges all files in all subdirectories also.", 0)

$filetype = InputBox ("Which file type?", "Which file type do you want  to merge... TXT, HTML, what?", "TXT")
$filelist =  _GetFilesFolder_Rekursiv(@ScriptDir, $filetype, 0, 0)

$bigfilename = FileSaveDialog ("Save merged files into which file?", @ScriptDir, "All (*.*)|Text files (*.txt)")
